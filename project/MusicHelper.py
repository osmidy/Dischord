...
class Note:
    ...
    def pitch_to_note(pitch, key):
        pitchToNoteSharp = {0: Notes.B_SHARP, 1: Notes.C_SHARP, 3: Notes.D_SHARP, 5: Notes.E_SHARP, 6: Notes.F_SHARP, 8: Notes.G_SHARP, 10: Notes.A_SHARP}
    ...
    def get_notes_in_key(key):
        ...
        for i in xrange(7):
            ...
            notes.append(Note.pitch_to_note(pitch,key))
        return notes
